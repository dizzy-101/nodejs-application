...
app.set('port', (process.env.PORT || 9983))
...
app.get('/klik', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  KLIK ENGINEERING. Please contact +2348037176206 for more information or send an email to klikengineering@yahoo.com <center></h2>" );
    response.end();
...
app.get('/redirect', function(req, res) {
    ...
    app.listen(app.get('port'), function() {
        console.log("Node JS app is running at http://localhost:" + app.get('port') +"/klik");
      })
